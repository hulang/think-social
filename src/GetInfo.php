...
final class GetInfo
{
    ...
    public static function qq($token)
    {
        ...
        if ($data['ret'] == 0) {
            ...
            throw new \Exception("获取[腾讯QQ]用户信息失败:{$data['msg']}");
        }
    }
    /**
     * 微信|用户信息
    ...
    public static function weixin($token)
    {
        ...
        if ($data['openid']) {
            ...
            throw new \Exception('获取[微信]用户信息失败');
        }
    }
    /**
     * 新浪微博|用户信息
    ...
    public static function sina($token)
    {
        ...
        if ($data['id']) {
            ...
            throw new \Exception("获取[新浪微博]用户信息失败：{$data['error']}");
        }
    }
    /**
     * 百度|用户信息
    ...
    public static function baidu($token)
    {
        ...
        if (isset($data['userid'])) {
            ...
            $userInfo['avatar'] = '//tb.himg.baidu.com/sys/portrait/item/' . $data['portrait'];
            $userInfo['openid'] = $data['userid'];
            $userInfo['sex'] = $data['sex'] == 1 ? '男' : '女';
            return $userInfo;
        } else {
            throw new \Exception('获取[百度]用户信息失败');
        }
    }
    /**
     * Gitee,码云|用户信息
    ...
    public static function gitee($token)
    {
        ...
        if (isset($data['id'])) {
            ...
            throw new \Exception('获取[Gitee]用户信息失败');
        }
    }
    /**
     * Github|用户信息
    ...
    public static function github($token)
    {
        ...
        if (isset($data['id'])) {
            ...
            throw new \Exception('获取[Github]用户信息失败');
        }
    }
    /**
     * Google,谷歌|用户信息
    ...
    public static function google($token)
    {
        ...
        if (isset($data['id'])) {
            ...
            throw new \Exception('获取[Google]用户信息失败');
        }
    }
    /**
     * Facebook|用户信息
    ...
    public static function facebook($token)
    {
        ...
        if (isset($data['id'])) {
            ...
            throw new \Exception('获取[Facebook]用户信息失败');
        }
    }
    /**
     * OSCHINA,中文开源技术交流社区|用户信息
     * @return mixed|array|Exception
     */
    public static function oschina($token)
    {
        ...
        if (isset($data['id'])) {
            ...
            throw new \Exception('获取[oschina]用户信息失败');
        }
    }
    /**
     * 淘宝|用户信息
    ...
    public static function taobao($token)
    {
        ...
        if (isset($data['taobao_user_id'])) {
            ...
            throw new \Exception('获取[淘宝]用户信息失败');
        }
    }
    /**
     * 抖音|用户信息
    ...
    public static function douyin($token)
    {
        ...
        if (isset($data['open_id'])) {
            ...
            throw new \Exception('获取[抖音]用户信息失败');
        }
    }
    /**
     * 小米|用户信息
    ...
    public static function xiaomi($token)
    {
        ...
        if (isset($data['unionId'])) {
            ...
            throw new \Exception('获取[小米]用户信息失败');
        }
    }
    /**
     * 钉钉|用户信息
    ...
    public static function dingtalk($token)
    {
        ...
        if ($data['openid']) {
            ...
            throw new \Exception('获取[钉钉]用户信息失败');
        }
    }
}
