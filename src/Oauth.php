...
abstract class Oauth
{
    ...
    /**
     * 获取 request_code 的额外参数 URL 查询字符串格式
     * @var mixed|srting
     */
    protected $Authorize = '';

    /**
     * 获取 request_code 请求的 URL
     * @var mixed|string
     */
    protected $GetRequestCodeURL = '';

    /**
     * 获取 access_token 请求的 URL
     * @var mixed|string
     */
    ...
    public function __construct($token = null)
    {
        ...
        $re_str = str_replace("hulang\\social\\sdk\\", '', $class);
     ...
     * @return mixed|array|Exception  $data   响应数据
     */
